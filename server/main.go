...
func generateMockResponse(messages []ChatMessage) string {
	responses := []string{
		...
		"確かに、その通りですね。他にも考えられる方法があります。",
		"素晴らしい質問です！これについて詳しく説明します。",
		"なるほど、理解しました。それについて詳しくお話ししましょう。",
		"とても良いポイントですね。これについて詳しく説明させていただきます。",
		"確かに、その観点は重要です。さらに詳しく検討してみましょう。",
		"興味深い視点ですね。これについて詳しく説明します。",
		"素晴らしいアイデアです！これについて詳しく話してみましょう。",
	}
